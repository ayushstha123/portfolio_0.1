    ...
    return (
        ...
        >
            ...
            <section className=" max-w-[1400px] mx-auto px-2 flex items-center justify-center">
                <div className="bg-gradient-to-b from-[#b3b3b3]  via-[#a1a1a1] to-[#F9F5F6] py-10 px-5 md:px-10 w-full rounded-4xl mt-10">
                    <motion.div
                    ...
                    <div className="text-white text-center spaicng tracking-wide md:tracking-normal lg:text-center ateoric text-[4rem] sm:text-[6.8rem] lg:text-[15rem] py-2 md:py-12 leading-[4rem] lg:leading-[11rem]"> Full-Stack Developer </div>
